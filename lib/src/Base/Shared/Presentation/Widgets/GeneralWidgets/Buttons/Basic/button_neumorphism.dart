...
import 'package:mobile/src/Base/Core/Constants/decorations/app_durations.dart';
...
class ButtonNeumorphism extends StatefulWidget {
  ...
  const ButtonNeumorphism({
    ...
    this.child,
    this.backColor, this.title, this.titleColor, this.titleSize, this.height, this.width,
  }) : super(key: key);
 ...
 //...
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: widget.isCircle?null: BorderRadius.circular(widget.curve.toRad()),
